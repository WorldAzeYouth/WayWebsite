    ...
    <footer className="bg-gradient-to-br from-[#134A8F] via-[#1e5ba8] to-[#0d3a78] text-white py-12 px-4 md:px-8 lg:px-12 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 max-w-7xl">
            ...
            <div className="w-full transform transition-all duration-700 hover:translate-y-[-10px]">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li
                    key={index}
                    className="transform transition-all duration-300 hover:translate-x-3 hover:scale-105"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <Link
                      href={item.href}
                      className="animated-underline relative group/link"
                    >
            ...
            <div className="w-full transform transition-all duration-700 hover:translate-y-[-10px]">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li
                    key={index}
                    className="transform transition-all duration-300 hover:translate-x-2 hover:scale-105"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
        ...
        <div className="flex justify-center md:justify-end mt-12 space-x-4">
          {[
            {
              href: "mailto:info@wayunion.org",
              icon: Mail,
              alt: "Email",
              color: "hover:bg-red-100",
            },
            {
              href: "https://www.linkedin.com/company/worldazeyouth-union/",
              icon: LinkedIn,
              alt: "LinkedIn",
              color: "hover:bg-blue-100",
            },
            {
              href: "https://www.instagram.com/worldazeyouth.az?igsh=MWdibm1yeGh5c3l2YQ%3D%3D&utm_source=qr",
              icon: Instagram,
              alt: "Instagram",
              color: "hover:bg-pink-100",
            },
            {
              href: "https://www.facebook.com/share/18pYkGSpof/?mibextid=wwXIfr",
              icon: Facebook,
              alt: "Facebook",
              color: "hover:bg-blue-100",
            },
            {
              href: "https://x.com/wayunion_az",
              icon: Twitter,
              alt: "Twitter",
              color: "hover:bg-gray-100",
            },
            {
              href: "https://www.tiktok.com/@worldazeyouth?_t=ZS-8waeBGgZAAb&_r=1",
              icon: Tiktok,
              alt: "TikTok",
        ...
        <div className="border-t border-white/20 mt-8 pt-6 flex items-center justify-center space-x-3 text-sm text-white/80 group">
          ...
          <a
            href="https://www.linkedin.com/in/farid-piriyev-a837ba381/"
            target="_blank"
            rel="noopener noreferrer"
            className="animated-underline font-medium  transition-all duration-300 transform hover:scale-110 hover:text-yellow-300"
          >
